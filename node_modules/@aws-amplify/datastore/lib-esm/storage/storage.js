...
var StorageClass = /** @class */ (function () {
    ...
    StorageClass.prototype.getUpdateMutationInput = function (model, originalElement, patchesTuple) {
        ...
        var _b = this.schema.namespaces[namespace].models[modelConstructor.name], fields = _b.fields, _c = _b.compositeKeys, compositeKeys = _c === void 0 ? {} : _c;
            ...
            if (!valuesEqual(source[key], originalElement[key])) {
                ...
                if (key in compositeKeys) {
                    try {
                        ...
                        for (var _b = __values(compositeKeys[key]), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var compositeField = _c.value;
